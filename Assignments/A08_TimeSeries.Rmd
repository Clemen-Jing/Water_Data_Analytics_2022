...
> The Clear Creek forecast captures the distinct seasonality of discharge in Clear Creek. As with
the Neuse River, the variability in discharge is not captured.