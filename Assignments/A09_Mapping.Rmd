...
start_point <- st_sfc(st_point(c(EnoCoords$dec_long_va, EnoCoords$dec_lat_va)), crs = 4269) 
...
> 368 square kilometers. 123 flowpaths of stream order 1, 45 of stream order 2, 19 of stream order 3, and 28 of stream order 4.

5. Are there any other gage sites in the upstream catchment? If so, where are they?
> There are two other gages, located in Hillsborough and Cole Mill Road.
