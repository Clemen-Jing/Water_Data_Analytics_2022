...
# dimiotic "s, |, reversed s, |" where "|" means the water mix well, as it may freeze, "s" or "reversed s" means that the water stratify into layers with different temperature. 
# monomiotic "|, |, reversed s, |"
# polymiotic they are too shallow to develop thermal stratification; thus, their waters can mix from top to bottom throughout the ice-free period. 
# amiotic: perennially sealed off by ice, from most of the annual seasonal variations in temperature.
