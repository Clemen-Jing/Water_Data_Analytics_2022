...
LAGOSjoined <- LAGOSnutrient %>%
  ...
  #drop_na() #only drop NAs in specific column, rather than the whole raw of data containing NA.
...
LAGOSMN <- LAGOSjoined %>%
  ...
  filter(sampledate > as.Date("1990-06-01")) %>%
...
#"type" decides the half part, diag
```
